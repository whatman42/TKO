...
hidden = [
    ...
    'tokocrypto_bot.security.credential_manager','tokocrypto_bot.ml.inference','tokocrypto_bot.ml.model_loader','tokocrypto_bot.ml.neutral_model','tokocrypto_bot.persistence.ml_journal',
...
a = Analysis(['tko_worker_entry.py'], pathex=[], binaries=[], datas=[('models/champion_model.pkl', 'models')], hiddenimports=hidden,
