...
MIGRATIONS = [
    ...
    {
        "version": 5,
        "description": "CL-0 ML prediction log and trade outcome journal",
        "queries": [
            """
            ...
            """,
            "CREATE INDEX IF NOT EXISTS idx_ml_pred_symbol_ts ON ml_prediction_log(symbol, feature_timestamp);",
            "CREATE INDEX IF NOT EXISTS idx_ml_pred_logged ON ml_prediction_log(logged_at);",
            """
            CREATE TABLE IF NOT EXISTS ml_trade_outcomes (
                ...
                holding_period_sec REAL,
                outcome_status TEXT NOT NULL DEFAULT 'OPEN',
                linked_at TEXT NOT NULL,
                UNIQUE(prediction_id, fill_id)
            );
            """,
            "CREATE INDEX IF NOT EXISTS idx_ml_out_symbol ON ml_trade_outcomes(symbol, linked_at);",
            "CREATE INDEX IF NOT EXISTS idx_ml_out_pred ON ml_trade_outcomes(prediction_id);",
        ],
    },
]
