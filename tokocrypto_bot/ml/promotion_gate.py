...
class ModelPromotionResult:
    champion_version: str; challenger_version: str; is_promoted: bool
    champion_expectancy: float; challenger_expectancy: float; expectancy_lift_pct: float; reason: str
class ModelPromotionGate:
    def __init__(self, min_expectancy_lift_pct=0.10): self.min_lift = min_expectancy_lift_pct
    def evaluate_promotion(self, champion_report, challenger_report, champion_version, challenger_version):
        ...
        return ModelPromotionResult(champion_version, challenger_version, False, champion_report.net_expectancy, challenger_report.net_expectancy, lift, "lift insufficient")
