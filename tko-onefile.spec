...
hidden = [
    ...
    'tokocrypto_bot.persistence.state_manager','tokocrypto_bot.recovery.live_gate','tokocrypto_bot.recovery.startup_recovery',
...
a = Analysis(['tko_worker_entry.py'], pathex=[], binaries=[], datas=[], hiddenimports=hidden,
    excludes=['PyQt6','matplotlib','scipy','sklearn','tensorflow','torch'], cipher=block_cipher, noarchive=False)
pyz = PYZ(a.pure, a.zipped_data, cipher=block_cipher)
exe = EXE(pyz, a.scripts, a.binaries, a.zipfiles, a.datas, [], name='TKO', debug=False, strip=False, upx=True, console=True)
